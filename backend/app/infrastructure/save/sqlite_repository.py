...
from app.infrastructure.save.sqlite_db import init_sqlite_database, sqlite_session_scope
from app.infrastructure.save.sqlite_orm_models import (
    LifeCurrentStateRow,
    LifeEventLogRow,
...
class SQLiteSaveRepository:
    ...
    def append_snapshot(self, snapshot: LifeYearSnapshot) -> None:
        ...
        with sqlite_session_scope() as session:
            ...
            stmt = stmt.on_conflict_do_update(
                index_elements=[LifeYearSnapshotRow.life_id, LifeYearSnapshotRow.age_after],
                set_={
